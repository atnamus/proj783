...
class RestoDashboardController extends RestoController {
    ...
    public function postAccount() {
        ...
        return Redirect::to(route('resto-profile'))->with('message', SiteHelpers::alert("success", "Successfully updated."));
    }
