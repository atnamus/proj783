    ...
    <div class="hor-menu">
        <div class="hor-menu hor-menu-light hidden-sm hidden-xs">
            <ul class="nav navbar-nav">
                <li class="@if($__controller == 'AdminSettingsController')active @endif">
                    <a href="{{route('admin.settings.index')}}" >
                        <span class="username username-hide-on-mobile">Settings</span>
                        @if($__controller == 'AdminSettingsController') <span class="selected"></span> @endif
                    </a>                    
                </li>
                <li class="@if($__controller == 'AdminPageController')active @endif">
                    <a href="{{route('admin.page.index')}}" >
                        <span class="username username-hide-on-mobile">Pages</span>
                        @if($__controller == 'AdminPageController') <span class="selected"></span> @endif
                    </a>                    
                </li>
            </ul>
        </div>
