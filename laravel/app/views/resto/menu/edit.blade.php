    ...
    <div class="col-md-12">
        <div class="portlet box {{$_theme['portlet_colour']}} ">
            ...
            <div class="portlet-body form">
                {{ Form::model($model,['url' => route('resto.menu.update',$model->id),'class'=>"form-horizontal ajax-submit",'role'=>"form",'method'=>'put']) }}
                <div class="form-body">
                    ...
                    <div class="form-group {{ $errors->has('category') ? 'has-error' : '' }}">
                        ...
                        <div class="col-md-9">
                            ...
                            {{ Form::select('category_id',[''=>'---select---']+MenuCategory::lists('name','id'),$model->category_id, array('class' => 'form-control input-large select2me'))}}
